...
export const LoginSignUp = () => {
  ...
  return (
    <div className="loginSignUp">
      <form
        className="signUp border border-dark m-3 p-2 "
      ...
      >
        ...
        <input
          type="checkbox"
          className="food form-check-input"
          {...register("food")}
        />
        <br />
        ...
        <input
          type="checkbox"
          className="movies form-check-input"
          {...register("movies")}
        />
        <br />
        ...
        <input
          type="checkbox"
          className="culture form-check-input"
          {...register("culture")}
        />
        <br />
        ...
        <input
          type="checkbox"
          className="art form-check-input"
          {...register("art")}
        />
        <br />
        ...
        <input
          type="checkbox"
          className="drama form-check-input"
          {...register("drama")}
        />
        <br />
        <label className="">image</label>
        <input type="text" className="image" {...register("image")} required />
        <br />
        <input type="submit" className="submitSignUpForm btn btn-warning" />
      </form>
      <form
        className="login border border-dark m-3 p-2"
        onSubmit={(e) => {
          e.preventDefault();
